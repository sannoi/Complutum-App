export let luchadores = [
  {
    ...
    ataques: [
      ...
      { nombre: 'Culo en Pompa', puntos_dano: 5, segundos_enfriamiento: 2 }
    ],
    especiales: [
  ...
  },
  {
    ...
    ataques: [
      { nombre: 'Plantón', puntos_dano: 13, segundos_enfriamiento: 4 },
      { nombre: 'Latigazo', puntos_dano: 6, segundos_enfriamiento: 2 }
    ],
    especiales: [
      { nombre: 'Rayo Solar', puntos_dano: 180, segundos_enfriamiento: 32 },
      { nombre: 'Lluvia de Esporas', puntos_dano: 90, segundos_enfriamiento: 15 }
    ]
  },
  {
    id: 'venusaur',
  ...
  },
  {
    ...
    ataques: [
      ...
      { nombre: 'Ascuas', puntos_dano: 6, segundos_enfriamiento: 2 }
    ],
    especiales: [
